...
export const TOOL_GROUPS: ToolGroup[] = [
    ...
    tools: [
      {
        ...
        summary:
          "Конкуренція, переможець, наскільки торги збили ціну, і збіги серед учасників: спільний телефон, пошта, адреса, контактна особа, час подання. Якщо поруч є індекс ЄДР, додає ще й спільних засновників та керівників. Кожен збіг приходить із поясненням, чому він може нічого не означати.",
        status: "працює",
        badges: ["source", "index"],
      },
    ],
  ...
  {
    id: "edr",
    title: "Реєстр юридичних осіб ЄДР",
    note: "Окремий сервер. Індекс будується раз на тиждень з офіційного bulk-експорту data.gov.ua, тому може відставати на кілька днів.",
    tools: [
      {
        name: "proyav_edr_search",
        summary:
          "Пошук компанії за назвою, коли коду ЄДРПОУ немає. Враховує українську морфологію і шукає також за скороченою назвою.",
        status: "працює",
        badges: ["index"],
      },
      {
        ...
        summary:
          "Картка компанії за ЄДРПОУ: назва, стан діяльності, засновники, керівники, кінцеві бенефіціарні власники.",
        status: "працює",
        badges: ["index"],
      },
      {
        name: "proyav_edr_shared_people",
        summary:
          "Спільні засновники, керівники чи бенефіціари між двома компаніями. Це збіг за іменем, не за ідентичністю особи: відповідь завжди нагадує про однофамільців.",
        status: "працює",
        badges: ["index"],
      },
    ],
